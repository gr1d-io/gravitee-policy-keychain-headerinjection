...
public class KeychainHeaderInjectionPolicyTest {
    ...
    private KeychainHeaderInjectionPolicy keychainHeaderInjectionPolicy;

    @Mock
    private KeychainHeaderInjectionPolicyConfiguration keychainHeaderInjectionPolicyConfiguration;
...
//        keychainHeaderInjectionPolicy = new KeychainHeaderInjectionPolicy(keychainHeaderInjectionPolicyConfiguration);
//        KeychainHeaderInjectionPolicy.API_KEY_QUERY_PARAMETER = null;
//        KeychainHeaderInjectionPolicy.API_KEY_HEADER = null;
//        when(request.metrics()).thenReturn(Metrics.on(System.currentTimeMillis()).build());
//        when(executionContext.getComponent(Environment.class)).thenReturn(environment);
//        when(environment.getProperty(eq(KeychainHeaderInjectionPolicy.API_KEY_HEADER_PROPERTY), anyString())).thenAnswer(invocation -> invocation.getArguments()[1]);
//        when(environment.getProperty(eq(KeychainHeaderInjectionPolicy.API_KEY_QUERY_PARAMETER_PROPERTY), anyString())).thenAnswer(invocation -> invocation.getArguments()[1]);
    }
...
//
//        keychainHeaderInjectionPolicy.onRequest(request, response, executionContext, policyChain);
//
...
//        keychainHeaderInjectionPolicy = new KeychainHeaderInjectionPolicy(null);
//
//        final HttpHeaders headers = new HttpHeaders();
//        headers.setAll(new HashMap<String, String>() {
//            {
...
//        when(environment.getProperty(eq(KeychainHeaderInjectionPolicy.API_KEY_HEADER_PROPERTY), anyString())).thenReturn(customHeader);
//
//        final HttpHeaders headers = new HttpHeaders();
//        headers.setAll(new HashMap<String, String>() {
//            {
...
//        when(environment.getProperty(eq(KeychainHeaderInjectionPolicy.API_KEY_QUERY_PARAMETER_PROPERTY), anyString())).thenReturn(customQueryParameter);
//
//        final HttpHeaders headers = new HttpHeaders();
//
...
//
//        final MultiValueMap<String, String> parameters = new LinkedMultiValueMap<>();
//        parameters.put(KeychainHeaderInjectionPolicy.DEFAULT_API_KEY_QUERY_PARAMETER, Collections.singletonList(API_KEY_HEADER_VALUE));
//
//        final ApiKey validApiKey = new ApiKey();
//        validApiKey.setRevoked(false);
//        validApiKey.setPlan(PLAN_NAME_HEADER_VALUE);
...
//        when(apiKeyRepository.findById(API_KEY_HEADER_VALUE)).thenReturn(Optional.of(validApiKey));
//
//        (new KeychainHeaderInjectionPolicy(null)).onRequest(request, response, executionContext, policyChain);
//
...
//        when(apiKeyRepository.findById(API_KEY_HEADER_VALUE)).thenReturn(Optional.of(validApiKey));
//
//        when(keychainHeaderInjectionPolicyConfiguration.isPropagateApiKey()).thenReturn(true);
//        keychainHeaderInjectionPolicy.onRequest(request, response, executionContext, policyChain);
//
